...
export const cases: CaseRecord[] = [
  ...
  { id: '#C-1044', status: 'In Progress', risk: 'Medium', date: '13 Jul 2025', summary: 'Workplace discrimination', location: 'Pune, Maharashtra', score: 57 },
  ...
  { id: '#C-1041', status: 'In Progress', risk: 'Medium', date: '11 Jul 2025', summary: 'Social boycott', location: 'Nashik, Maharashtra', score: 48 },
]
...
export const chatMessages: ChatMessage[] = [
  { id: 1, sender: 'ai', text: "Hi, I'm Sahayak, your AI support assistant. I'm here to listen and help. You can share only what you're comfortable with.", time: '10:24 AM' },
