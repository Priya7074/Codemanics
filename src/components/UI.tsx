...
export function ConsentNotice() {
  return <div className="notice notice-blue"><ShieldCheck size={18} /><span><b>Your privacy matters.</b> You control what you share. Sahayak uses your information only to connect you with support.</span></div>
}
