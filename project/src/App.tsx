...
import { AdminAnalyticsPage, AIChatPage, AssessmentPage, AssessmentResultPage, CaseDetailPage, ConsentPage, HelpSelectionPage, LandingPage, LoginPage, OfficerDashboardPage, ReportIncidentPage, SupportServicesPage } from './pages/Pages'
import { SessionProvider } from './contexts/SessionContext'
import './styles/global.css'

type Route = 'landing' | 'login' | 'help' | 'consent' | 'chat' | 'assessment' | 'result' | 'report' | 'support' | 'officer' | 'case-detail' | 'analytics'
